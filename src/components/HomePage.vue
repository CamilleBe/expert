<template>
  <div class="min-h-screen bg-white text-gray-800">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-10">
        <div class="max-w-3xl">
          ...
          <div class="animate-fade-in-delay-2">
            <form class="bg-white rounded-xl shadow-lg p-2 sm:p-3 md:p-4 flex flex-col sm:flex-row items-stretch">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 animate-fade-in-delay">
    ...
    <!-- Section CTA -->
    <div class="bg-blue-600 py-16 md:py-20">
    ...
    <footer class="bg-gray-900 text-white py-12">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="pt-8 border-t border-gray-800 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
